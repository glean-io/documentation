...
Once you add a database connection, it will be made available from the [Add Data Model](/data-modeling/add-data-model) workflow and you'll be able to specify tables or SQL queries to start visualizing data in Glean.
...
<Callout type="info" emoji="✏️">
  **Specifying Schemas** For most database types, you can optionally specify a
  ...
  made available in the [Add Data Model](/data-modeling/add-data-model) workflow
</Callout>
