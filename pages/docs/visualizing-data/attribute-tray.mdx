...
By default, there is one tile for each attribute in your data model in your attribute tray. You can scroll left and right to reveal all of the attributes. The attribute tray immediately allows you to see the metric values for your data as well as filter and breakout data. There are a few actions which every attribute tile allows you to do:
