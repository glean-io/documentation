...
### Exploring further from the tooltip 

You can also easily explore other models with the data in that item: 

<img src="/model_hop_tooltip.png" alt="Explore other models with this value" style={{ maxWidth: 450 }} />

Choose another model attribute to explore that model with a filter created from the item's data. You can choose any attribute with the same type from any model in your project. 