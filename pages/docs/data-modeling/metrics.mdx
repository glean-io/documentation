...
You will setup and update metrics from the [Add Data Model](/data-modeling/add-data-model) workflow.
...
The row count metric is added by default to a data model and can't be removed. This is intentional - see the best practices for defining this metric in the [Data Modeling Best Practices](/data-modeling/data-modeling-best-practices)
...
1. Go to the [Add Data Model](/data-modeling-add-data-model) workflow by creating a new data model or editing an existing model
