...
<Callout type="warning">
  ...
  save the [configuration](/data-ops/Managing-Resources-With-Code) of one or
  more of your resources to your local environment or a Git repository. Then,
  you can create a Build using the [Glean command-line interface
  (CLI)](/data-ops/Using-the-Glean-CLI), or through the Glean web application by
  connecting your account to a [Git repository](/data-ops/Git-Integration).
</Callout>
