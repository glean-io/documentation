...
PS - If you’re not quite ready to share Glean views publicly, you can choose to [embed](/docs/sharing-data-externally/iframe-embedding/) authenticated Data Models, Saved Views and Dashboards in external applications.
